...
- Are there at least 4 strong causes? If not → FAIL
- Does each cause include mechanism + signal? If not → FAIL
- Does this feel like a technician diagnosing a real system? If not → FAIL
